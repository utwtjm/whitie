...
<link rel="stylesheet" type="text/css" href="php_test/unit_test.css" charset="utf-8">
...
<body>
	...
	<script type="text/javascript">
		...
		// 顯示 test data 結果
		function show_result(function_name) {

			var test_result = document.getElementById(function_name);

			if(test_result.style.display == 'none') {
