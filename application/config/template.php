...
|
*/
$config['OCU_default_theme'] = "flat";


/*
|--------------------------------------------------------------------
| 前台預設的 theme file name
|--------------------------------------------------------------------
| This is the folder name that contains the default theme to use
| when 'OCU_use_mobile_themes' is set to TRUE.
|
...
/*
|--------------------------------------------------------------------
| 後台預設的 theme  file name
|--------------------------------------------------------------------
| This is the folder name that contains the default theme to use
| when 'OCU_use_mobile_themes' is set to TRUE.
|
*/
$config['OCU_admin_layout'] = "admin";
...
|
*/
$config['OCU_agent_theme'] = 'default';
...
// iphone 對應 views/iphone 目錄， apple iphone 則對應 template / _set_theme / agent
