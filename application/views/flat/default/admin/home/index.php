                ...
                <div class="timeline-scrollable">
                    ...
                    <ul class="timeline">
                        ...
                        <li class="clearfix">
                            ...
                            <img src="<?php echo public_image_url('/placeholders/image_64x64_dark.png')?>" alt="Avatar" class="timeline-avatar">
                        ...
                        <div class="scrollable">
                            ...
                            <div class="media">
                                <a href="javascript:void(0)" class="pull-left" data-toggle="tooltip" title="Username">
                                    <img src="<?php echo public_image_url('/placeholders/image_64x64_dark.png')?>" class="media-object img-circle" alt="Image">
                                </a>
                            ...
                            <div class="media">
                                <a href="javascript:void(0)" class="pull-left" data-toggle="tooltip" title="Username">
                                    <img src="<?php echo public_image_url('/placeholders/image_64x64_light.png')?>" class="media-object img-circle" alt="Image">
                                </a>
                                <div class="media-body">
                                    <h5 class="media-heading">
                                        <a href="javascript:void(0)" class="badge badge-neutral" data-toggle="tooltip" title="Reply"><i class="icon-reply"></i></a>
        ...
        <div class="block-content">
            <div class="gallery" data-toggle="lightbox-gallery">
                <div class="row-fluid row-items">
                    <div class="span2">
                        <a href="<?php echo public_image_url('/placeholders/image_720x450_dark.png')?>" class="gallery-link">
                            <img src="<?php echo public_image_url('/placeholders/image_720x450_dark.png')?>" alt="image">
                        </a>
                    </div>
                    <div class="span2">
                        <a href="<?php echo public_image_url('/placeholders/image_720x450_light.png')?>" class="gallery-link">
                            <img src="<?php echo public_image_url('/placeholders/image_720x450_light.png')?>" alt="image">
                        </a>
                    </div>
                    <div class="span2">
                        <a href="<?php echo public_image_url('/placeholders/image_720x450_dark.png')?>" class="gallery-link">
...
$(function() {
    ...
    setTimeout(function() {
        $('<li class="clearfix">' +
            ...
            '<span class="timeline-meta-time">just now</span>' +
            '<img src="<?php echo public_image_url('/template/pixelcave.png')?>" alt="pixelcave" class="img-circle timeline-avatar">' +
