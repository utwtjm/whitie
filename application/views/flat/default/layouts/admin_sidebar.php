...
<aside id="page-sidebar" class="nav-collapse collapse">
    ...
    <div class="mini-profile">
        <div class="mini-profile-options">
            ...
            <a href="<?php echo web_url('/user/logout'); ?>" class="badge badge-important" data-toggle="tooltip" data-placement="right" title="Log out">
    ...
    <nav id="primary-nav">
        <ul>
            ...
            <li>
                <a href="#"><i class="glyphicon-vector_path_curve"></i>User Interface</a>
                <ul>
                    <li>
            ...
            <li>
                <a href="#"><i class="glyphicon-table"></i>Tables</a>
                <ul>
                    <li>
            ...
            <li>
                <a href="#"><i class="glyphicon-more_windows"></i>Forms</a>
                <ul>
                    <li>
            ...
            <li>
                <a href="#"><i class="glyphicon-fire"></i>Components</a>
                <ul>
                    <li>
            ...
            <li>
                <a href="#"><i class="glyphicon-pizza"></i>Icon Packs</a>
                <ul>
                    <li>
            ...
            <li>
                <a href="#"><i class="glyphicon-certificate"></i>Ready UI</a>
                <ul>
                    <li>
                    ...
                    <li>
                        <a href="page_ready_errors.html">Errors</a>
                    </li>
                    <li>
